...
public class OpenCvRemoteCameraConfigurationWizard extends ReferenceCameraConfigurationWizard {
    private final OpenCvRemoteCamera camera;
    ...
    public OpenCvRemoteCameraConfigurationWizard(OpenCvRemoteCamera camera) {
        ...
        JLabel lblDeviceId = new JLabel("Device URI");
        panelGeneral.add(lblDeviceId, "2, 2, right, default");

        deviceUriTextField = new JTextField();
    ...
    public void createBindings() {
        ...
        addWrappedBinding(camera, "deviceURI", deviceUriTextField, "text");
